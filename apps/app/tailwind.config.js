  ...
  theme: {
    extend: {
      boxShadow: {
        ...
        'button-sm':
          '3px 3px 0 0 rgba(0,0,0,0.12), 3px 3px 0 0 rgba(0,0,0,0.12)',
        'button-md': '6px 6px 0 0 rgba(0,0,0,0.12)',
        'button-lg': '12px 12px 0 0 rgba(0,0,0,0.12)',
      },
      colors: {
        'neon-green': ({ opacityValue }) =>
          `rgba(73, 251, 53, ${opacityValue})`,
        'dark-blue': '#13274F',
      },
      dropShadow: {
        'neon-green':
          '0 0 2px rgba(255, 255, 255, 0.5)) drop-shadow(0 0 8px rgba(255, 255, 255, 0.5)) drop-shadow(0 0 16px rgba(255, 255, 255, 0.7))  drop-shadow(0 0 24px rgba(73, 251, 53, 1)) drop-shadow(0 0 36px rgba(73, 251, 53, 1)) drop-shadow(0 0 48px rgba(73, 251, 53, 1)',
      ...
      animation: {
        ...
        record: 'record 3s linear infinite',
      },
    },
  },
  variants: {
